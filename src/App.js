        ...
        >
          ...
          <div className="relative grid md:grid-cols-5 gap-8 items-center">
            <div className="md:col-span-3 text-white">
              ...
              <a
                href="https://wa.me/919441830310?text=Hi%20Girnar%20Beverages%2C%20I%27m%20interested%20in%20Oxeneon%20Pure%20Water."
                target="_blank"
                rel="noopener noreferrer"
            ...
            >
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <a
                    href={`https://wa.me/919441830310?text=Hi%20Girnar%20Beverages%2C%20I%27m%20interested%20in%20your%20${encodeURIComponent(selectedProduct.name)}%20(${encodeURIComponent(selectedProduct.capacity)})`}
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        >
          ...
          <div className="relative grid md:grid-cols-2 gap-10 items-center">
            <div className="text-white">
              ...
              <a
                href={`https://wa.me/919441830310?text=${encodeURIComponent(
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/919441830310?text=${encodeURIComponent(message)}`, '_blank');
  };
...
export default App;// STATIC DATA
// ============================================
